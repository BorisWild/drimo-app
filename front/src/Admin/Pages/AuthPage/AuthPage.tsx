  ...
  const handleLogin = async () => {
    ...
    if (email.includes('@') && password.length >= 8) {
      axios.post(`${getAuthURL()}/email_login`,
        ...
        .then(({ data }) => {
          console.log(data)
          document.cookie = `apiTokenAdmin=${data.access_token}; path=/; max-age=2592000;`
          document.cookie = `refreshTokenAdmin=${data.refresh_token}; path=/; max-age=2592000;`
          document.cookie = `userIdAdmin=${data.id}; path=/; max-age=2592000;`
